...
# In class
```{r}
#use auto_power_gen function
source(here("R/auto_power_gen.R"))

#compute power, given a truck of m=31752 kg (parameters for a heavy truck) for a range of different highway speeds (30 m/s, 80 km/hr (22.22 m/s), 120 km/hr (33.33 m/s), 40 km/hr (11.11 m/s), 5km/hr (1.39 m/s)) The surface area is 16 m2.
power = auto_power_gen(m=31752, A=16, V=c(30, 22.22, 33.33, 11.11, 1.39))
power
...
#lighter vehicle
power_lighter = auto_power_gen(m=10000, A=16, V=c(30, 22.22, 33.33, 11.11, 1.39))


power_speed_lighter = data.frame(power_lighter, 
                speed = c(30, 22.22, 33.33, 11.11, 1.39))

#plot
ggplot()+
  geom_line(data = power_speed, aes(x = speed, y = power), color = "red")+
  geom_line(data = power_speed_lighter, aes(x = speed, y = power_lighter), color = "blue")
```
